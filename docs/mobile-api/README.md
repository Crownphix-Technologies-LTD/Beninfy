...
| Mobile driver profile/home/trips/actions | `/api/mobile/v1/driver/*`                                                                                         | IMPLEMENTED    | Linked-driver profile, Home projection, assigned trips, assignment history, and lifecycle actions.             |
