...
| Places search                        | `/api/mobile/v1/places/autocomplete`, `/api/mobile/v1/places/:placeId`                                            | IMPLEMENTED    | Backend-owned Google Places API (New); Flutter receives safe location DTOs only.                               |
